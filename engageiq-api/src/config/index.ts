...
const envSchema = z.object({
  ...
  APP_NAME: z.string().default('Mailvex-api'),
  ...
  REDIS_KEY_PREFIX: z.string().default('Mailvex:'),

  // NATS
  NATS_URL: z.string().url(),
  NATS_NAME: z.string().default('Mailvex-api'),
  ...
  JWT_ISSUER: z.string().default('Mailvex'),
  JWT_AUDIENCE: z.string().default('Mailvex-api'),
